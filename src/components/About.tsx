		...
		<section id="about" className="py-20 px-6 bg-gray-800 bg-opacity-50">
			<div className="max-w-4xl mx-auto">
				...
				<div className="space-y-4 text-gray-300 leading-relaxed">
					<p>
						{" "}
						I&apos;m a full-stack software developer with a strong
						focus on building clean, scalable, and high-performing
						web applications. I work primarily with modern
						JavaScript frameworks like Next.js and React, alongside
					...
					<p>
						{" "}
						When I&apos;m not shipping features or refining a
						codebase, you&apos;ll find me exploring new tools,
						improving my workflow, experimenting with AI
						integrations, or learning ways to build faster and
						smarter in modern web ecosystems.{" "}
					</p>
				</div>
			</div>
		</section>
